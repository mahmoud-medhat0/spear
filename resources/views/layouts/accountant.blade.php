...
<body class="hold-transition sidebar-mini layout-fixed sidebar-closed sidebar-collapse">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <p class="nav-link">{{ __('money').' = '.$money }}</p>
                </li>
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link
                            ...
                            {{ 'active' }}
                            @elseif (session()->get('active') == 'accountant')
                            {{ 'active' }}
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('accountant') }}" class="nav-link
                                    @if (session()->get('active') == 'accountant') {{ 'active' }} @endif
                                    ">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('accountant_addorders') }}" class="nav-link
                                            @if (session()->get('active') == 'accountant_addorders') {{ 'active' }} @endif
                                            ">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('accountant_neworders') }}" class="nav-link
                                    @if (session()->get('active') == 'accountant_neworders') {{ 'active' }} @endif
                                    ">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>{{ __("orders_add") }}</p>
                                </a>
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link
                            @if (session()->get('active') == 'accountant_supplies_newd')
                            {{ 'active' }}
                            @elseif (session()->get('active') == 'accountant_hold_supplies')
                            {{ 'active' }}
                            @endif
                            ">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('accountant_supplies_newd') }}" class="nav-link
                                    @if (session()->get('active') == 'accountant_supplies_newd') {{ 'active' }} @endif
                                    ">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('accountant_hold_supplies') }}" class="nav-link
                                    @if (session()->get('active') == 'accountant_hold_supplies') {{ 'active' }} @endif
                                    ">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('accountant_add_personfin') }}" class="nav-link
                                        @if (session()->get('active') == 'accountant_add_personfin') {{ 'active' }} @endif
                                        ">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('accountant_pesronsfin') }}" class="nav-link
                                        @if (session()->get('active') == 'accountant_pesronsfin') {{ 'active' }} @endif
                                        ">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('accountant_add_finance') }}" class="nav-link
                                        @if (session()->get('active') == 'accountant_add_finance') {{ 'active' }} @endif
                                        ">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link
                            @if (session()->get('active') == 'accountant_orders_history')
                            {{ 'active' }}
                            @elseif (session()->get('active') == 'accountant_history_arcieve')
                            {{ 'active' }}
                            @endif
                            ">
                            <i class="nav-icon fas fa-edit"></i>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('accountant_orders_history') }}" class="nav-link
                                    @if (session()->get('active') == 'accountant_orders_history') {{ 'active' }} @endif
                                    ">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('accountant_history_arcieve') }}" class="nav-link
                                    @if (session()->get('active') == 'accountant_history_arcieve') {{ 'active' }} @endif
                                    ">
                                    <i class="far fa-circle nav-icon"></i>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2023 <a href="https://zenonsoftware.com">ZenonSoftware</a>.</strong>
        All rights reserved.
