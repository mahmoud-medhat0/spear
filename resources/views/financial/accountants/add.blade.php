...
<div class="card card-default" bis_skin_checked="1">
    ...
    @endif
    <form action="{{ route('store_finance') }}" class="form-group" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card-body" bis_skin_checked="1">
            <div class="row" bis_skin_checked="1">
                <div class="form-group col-md-6" bis_skin_checked="1">
                    <label>{{ __('statement_person') }}</label>
                    <select name="person" class="form-control select2bs4 select2-hidden-accessible"
