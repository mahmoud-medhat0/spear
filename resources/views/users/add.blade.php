...
<div class="card card-default" bis_skin_checked="1">
    ...
    @endif
    <form action="{{ route('user_store') }}" class="form-group" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card-body" bis_skin_checked="1">
            <div class="row" bis_skin_checked="1">
                ...
                <div class="col-sm-6" bis_skin_checked="1">
                    ...
                    <div class="form-group" bis_skin_checked="1">
                        ...
                        <select name="gender" class="form-control">
                            ...
                            <option @selected(old('gender')=="m" ) value="m">{{ __("male") }}</option>
                            <option @selected(old('gender')=="f" ) value="f">{{ __("female") }}</option>
                        </select>
                        @error('gender')
                        <div class="text-danger font-weight-bold">*{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group col-md-6" bis_skin_checked="1">
                    <label for="exampleInputFile2">{{ __("driving_license") }}</label>
                    <div class="input-group" bis_skin_checked="1">
                        <div class="custom-file" bis_skin_checked="1">
                            <input name="drvlicence" value="{{ old('drvlicence') }}" type="file" id="exampleInputFile2"
                                accept="application/pdf" />
                ...
                <div class="form-group col-md-6" bis_skin_checked="1">
                    <label for="exampleInputFile1">{{ __("bike_license") }}</label>
                    <div class="input-group" bis_skin_checked="1">
                        <div class="custom-file" bis_skin_checked="1">
                            <input name="bilkelicense" value="{{ old('bilkelicense') }}" type="file"
                                id="exampleInputFile1" accept="application/pdf" />
                ...
                <div class="form-group col-md-6" bis_skin_checked="1">
                    ...
                    <select name="rank" class="form-control select2bs4 select2-hidden-accessible" style="width: 100%;"
                        ...
                        <option @selected(old('rank')==$rank->id ) value="{{ $rank->id }}">
                            @if (app()->getLocale()=="en")
                            {{ $rank->name }}
                ...
                <div class="form-group col-md-6" bis_skin_checked="1">
                    ...
                    <input class="form-control" name="phonep" rows="3" value="{{ old('phonep') }}"
                ...
                <div class="form-group col-md-6" bis_skin_checked="1">
                    ...
                    <input class="form-control" name="phonew" value="{{ old('phonew') }}" rows="3"
                ...
                <div class="form-group col-md-6" bis_skin_checked="1">
                    ...
                    <input class="form-control" name="phone3" value="{{ old('phone3') }}" rows="3"
                ...
                <div class="form-group col-md-6" bis_skin_checked="1">
                    ...
                    <input type="number" class="form-control" value="{{ old('commision') }}" name="commision" rows="3"
                ...
                <div class="form-group col-md-6" bis_skin_checked="1">
                    ...
                    <select name="company_id" class="form-control select2bs4 select2-hidden-accessible"
                        ...
                        <option @selected(old('company_id')==$company->id ) value="{{ $company->id }}">{{ $company->name
                            }}</option>
                        @endforeach
                    </select>
                    @error('company_id')
