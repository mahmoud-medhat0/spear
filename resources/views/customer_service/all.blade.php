...
<section class="content">
    ...
    <div class="container-fluid">
        <input class="btn btn-primary w-15" type="button" onclick="selects();" value="Select All">
        <input class="btn btn-info w-15" type="button" onclick="deSelect();" value="deSelect All">
        <a href="{{ route('user_add') }}" class="btn btn-primary w-15 ">Add New</a>
        <a href="" class="btn btn-primary  w-15">Download stamp</a>
