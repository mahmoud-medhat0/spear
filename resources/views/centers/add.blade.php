...
<div class="card card-default" bis_skin_checked="1">
    ...
    @endif
    <form action="{{ route('center_store') }}" class="form-group" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row" bis_skin_checked="1">
                ...
                <div class="form-group col-md-6" bis_skin_checked="1">
                    ...
                    <select name="governorate" class="form-control select2bs4 select2-hidden-accessible"
                        ...
                        <option @selected(old('rank')==$governorate->id ) value="{{ $governorate->id }}">
                            @if(app()->getLocale()=="en")
                ...
                <div class="form-group col-md-6" bis_skin_checked="1">
                    ...
                    <select name="agentid" class="form-control select2bs4 select2-hidden-accessible"
                        ...
                        <option @selected(old('agentid')==$agent->id ) value="{{ $agent->id }}">{{
                            $agent->name }}</option>
                        @endforeach
                    </select>
                    @error('agentid')
